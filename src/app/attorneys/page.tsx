  ...
  return (
    <div className="bg-[#f6f3ee]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-8">
          <h1 className="serif-ed text-3xl sm:text-4xl text-[#14181f] mb-2">
            Find an Attorney
          </h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
          {states.map((state) => (
            <Link
              ...
              className="group px-4 py-4 bg-white rounded-2xl border border-[#e2ddd3] hover:border-[#d4cebf] hover:shadow-sm transition-all"
            >
              <p className="font-medium text-[#14181f] group-hover:text-[#0f7d6c] transition-colors">
                {state.name}
              </p>
              <p className="text-xs text-[#8a93a1] mt-1">
